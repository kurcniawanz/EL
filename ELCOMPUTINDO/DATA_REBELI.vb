...
Public Class DATA_REBELI
    ...
    Private Sub DATA_REBELI_KeyDown(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        Dim row As Integer
        row = dgv_dat.CurrentRow.Index.ToString
        ...
        If e.KeyCode = Keys.F1 Then
            ...
            If Tanya = Windows.Forms.DialogResult.Yes Then
                ...
                PRINT.ReportViewer1.LocalReport.ReportEmbeddedResource = "ELCOMPUTINDO.PRINT_REBELI.rdlc"
