...
Public Class INPUT_PENDAPATAN
    ...
    Sub nomor()
        ...
        If rddd.Read Then
            ...
            vall = Val(temp) + 1
            txtid.Text = vall
            txtnokas.Text = "DL" + y + m + "000" + vall.ToString
        Else
            txtid.Text = 1
            txtnokas.Text = "DL" + y + m + "0001"
        End If
        konek.Close()
    End Sub

    Private Sub INPUT_PENDAPATAN_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        namasup()
        namabank()
